...
# Parameters for synthetic image generation
    ...
    parser.add_argument(
        ...
        action="store_true",
        default=False,
        help="Set this flag to use autocast",
    )
    parser.add_argument(
        "--bit16",
        action="store_true",
        default=False,
        help="Set this flag to cast the model to 16bit FP.",
    )
    parser.add_argument(
        "--batch_size_TtI;",
        type=int,
    ...
    parser.add_argument(
        ...
        type=int,
        default=384,
        help="Height of imaages generated by Stable Diffusion.",
    )
    parser.add_argument(
        "--width",
        type=int,
        default=512,
        help="Width of imaages generated by Stable Diffusion.",
    )
    parser.add_argument(
        "--seed",
        type=int,
    ...
    parser.add_argument(
        "--use_model_defaults",
        default=False,
        help="Set this flag to not use the entered guidance scale and number of inference steps but instead the model defaults. Needed for stable diffusion v2-1",
    )
    parser.add_argument(
        "--none_safety_checker",
        action="store_true",
        default=True,
        help="Set this flag to set the safety checker to none instead of a lambda that always returns true. The safety checker should be disabled either way. Needed for stable diffusion v2-1",
    )
    parser.add_argument(
        "--normalize_channels",
        action="store_true",
